...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            <i class="fa fa-inr"></i> <?php echo $this->lang->line('income'); ?></h1>
    </section>
    <!-- Main content -->
                        ...
                        <form action="<?php echo site_url("admin/incomehead/edit/" . $id) ?>"  id="employeeform" name="employeeform" method="post" accept-charset="utf-8">
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" id="description" name="description" placeholder="" rows="3" placeholder="Enter ..."><?php echo set_value('description', $incomehead['description']); ?></textarea>
