...
$gr_class_label = method_exists($this, 'gyanrank_erp_label') ? $this->gyanrank_erp_label('class') : $this->lang->line('class');
$gr_section_label = method_exists($this, 'gyanrank_erp_label') ? $this->gyanrank_erp_label('section') : $this->lang->line('section');
$gr_student_label = method_exists($this, 'gyanrank_erp_label') ? $this->gyanrank_erp_label('student') : $this->lang->line('student');
$gr_student_list_label = method_exists($this, 'gyanrank_erp_label') ? $this->gyanrank_erp_label('student_list') : ($this->lang->line('student') . ' ' . $this->lang->line('list'));
?>
                                ...
                                <div class="row">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                <label><?php echo $gr_class_label; ?></label><small class="req">  *</small>
                                    ...
                                    ?>
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                <label><?php echo $gr_section_label; ?></label>
            ...
            <input type="text" name="search_text" id="search_text" class="form-control" value="<?php echo set_value('search_text'); ?>" placeholder="<?php echo $this->lang->line('search_by_student_name'); ?>">
                        ...
                        <div class="">
                            ...
                            <div class="box-header ptbnull">
                                <h3 class="box-title titlefix"><i class="fa fa-users"></i> <?php echo $gr_student_list_label; ?>
                            ...
                            <div class="box-body">
                                ...
                                <table class="table table-striped table-bordered table-hover student-list" data-export-title="<?php echo $gr_student_list_label; ?>">
                                    <thead>

                                        <tr>
                                            <th><?php echo $gr_class_label; ?></th>
                                            <th><?php echo $gr_section_label; ?></th>

                                            <th><?php echo $this->lang->line('admission_no'); ?></th>

                                            <th><?php echo $gr_student_label; ?> <?php echo $this->lang->line('name'); ?></th>
