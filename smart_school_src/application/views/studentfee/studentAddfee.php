...
$language_name   = isset($language["short_code"]) ? $language["short_code"] : "en";
$gr_class_section_label = method_exists($this, 'gyanrank_erp_label') ? $this->gyanrank_erp_label('class_section') : $this->lang->line('class_section');
$gr_fees_group_label = method_exists($this, 'gyanrank_erp_label') ? $this->gyanrank_erp_label('fees_group') : $this->lang->line('fees_group');
?>
                                            ...
                                            <table class="table table-striped mb0 font13">
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <th class="bozero"><?php echo $gr_class_section_label; ?></th>
                            ...
                            <table class="table table-striped table-bordered table-hover example table-fixed-header">
                                <thead class="header">
                                    <tr>
                                        ...
                                        <th align="left"><?php echo $gr_fees_group_label; ?></th>
