                                ...
                                <form method='post' action='<?php echo $transactionURL; ?>' name='f1'>
                                    ...
                                    <tr class="bordertoplightgray">
                                        ...
                                        <tr class="bordertoplightgray">
                                            ...
                                            <td  bgcolor="#fff" class="text-right"> <button type="submit"  name="search"  value="" class="btn btn-info"><?php echo $this->lang->line('pay_with_paytm'); ?>  <i class="fa fa fa-chevron-right"></i></button>  </td>
                                        </tr>
                                    </table>
