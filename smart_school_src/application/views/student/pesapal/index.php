                    ...
                    <div class="col-md-6 col-md-offset-3 mt20">
                        <div class="paymentbg">
                            ...
                            <div class="padd2 paddtzero">
                                <form action="<?php echo base_url(); ?>students/pesapal/pesapal_pay" method="post">
                                	<?php 
...
<hr>
                                    <tr class="bordertoplightgray">
                                        ...
                                        <td  bgcolor="#fff" class="text-right"> <button type="submit"  name="search"  value="" class="btn btn-info"><?php echo $this->lang->line('pay_with_pesapal'); ?> <i class="fa fa fa-chevron-right"></i></button>  </td>
                                    </tr>
                                </table>
