                                ...
                                <form action="<?php echo base_url(); ?>students/paystack/paystack_pay" method="post">
                                    ...
                                    <tr class="bordertoplightgray">
                                        ...
                                        <tr class="bordertoplightgray">
                                            ...
                                            <td  bgcolor="#fff" class="text-right"> <button type="submit"  name="search"  value="" class="btn btn-info"><?php echo $this->lang->line('pay_with_paystack'); ?> <i class="fa fa fa-chevron-right"></i></button>  </td>
                                        </tr>
                                    </table>
