                    ...
                    <div class="col-md-6 col-md-offset-3 mt20">
                        <div class="paymentbg">
                            <div class="invtext"><?php echo $this->lang->line('fees_payment_details'); ?> </div>
                             ...
                             <?php if ($api_error) { ?><br> <center><div class="alert alert-danger">  <?php echo $api_error ?> </div></center> <?php } ?>
 

                            <div class="padd2 paddtzero">
                                <form action="<?php echo base_url(); ?>students/sslcommerz/pay" method="post">
                                   <table class="table2" width="100%">
                                    ...
                                    <tr class="bordertoplightgray">
                                        ...
                                        <tr class="bordertoplightgray">
                                            ...
                                            <td  bgcolor="#fff" class="text-right"> <button type="submit"  name="search"  value="" class="btn btn-info"><?php echo $this->lang->line('pay').' '.$this->lang->line('sslcommerz').' '.$this->lang->line('payment'); ?>  <i class="fa fa fa-chevron-right"></i></button>  </td>
                                        </tr>
                                    </table>
