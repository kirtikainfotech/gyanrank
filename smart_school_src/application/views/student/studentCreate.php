                            ...
                            <div class="bozero">
                                ...
                                <div class="around10">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label for="exampleInputEmail1"><?php echo $gr_class_label; ?></label><small class="req"> *</small>
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <div class="form-group">
                                                <label for="exampleInputEmail1"><?php echo $gr_section_label; ?></label><small class="req"> *</small>
                ...
                <div class="form-horizontal">
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <label for="inputEmail3" class="col-sm-2 control-label"><?php echo $gr_class_label; ?></label>
                            <div class="col-sm-10">
                        ...
                        <div class="form-group">
                            <label for="inputPassword3" class="col-sm-2 control-label"><?php echo $gr_section_label; ?></label>
                            <div class="col-sm-10">
                        ...
                        <div class="form-group">
                            <label for="inputPassword3" class="col-sm-2 control-label"><?php echo $gr_student_label; ?>
                            </label>
