    ...
    <li class="dropdown">
        ...
        <ul class="dropdown-menu verticalmenu" style="min-width:194px;font-size:10pt;left:3px;">
            ...
            <?php } if ($this->rbac->hasPrivilege('income', 'can_add')) { ?>
                ...
                <li role="presentation"><a style="color:#282828; font-family: 'Roboto-Bold';padding:6px 20px;" role="menuitem" tabindex="-1" href="<?php echo base_url(); ?>admin/income"> &nbsp;<i class="fa fa-inr"></i> <?php echo $this->lang->line('add_income'); ?></a></li>
            <?php } ?>
