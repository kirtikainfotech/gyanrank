<aside class="main-sidebar" id="alert2">
    <?php
    $gr_can_feature = function ($feature) {
        return !method_exists($this, 'gyanrank_has_plan_feature') || $this->gyanrank_has_plan_feature($feature);
    };
    ?>
    ...
    <section class="sidebar" id="sibe-box">
        ...
        <ul class="sidebar-menu verttop">
            <?php
if ($this->module_lib->hasActive('front_office') && $gr_can_feature('front_office')) {
...
if ($this->module_lib->hasActive('student_information') && $gr_can_feature('student')) {
...
if ($this->module_lib->hasActive('fees_collection') && $gr_can_feature('fees')) {
...
if ($this->module_lib->hasActive('income') && $gr_can_feature('income')) {
    if (($this->rbac->hasPrivilege('income', 'can_view') ||
        ...
        ?>
                    ...
                    <li class="treeview <?php echo set_Topmenu('Income'); ?>">
                        <a href="#">
                            <i class="fa fa-inr ftlayer"></i> <span><?php echo $this->lang->line('income'); ?></span> <i class="fa fa-angle-left pull-right"></i>
                        </a>
                        <ul class="treeview-menu">
...
if ($this->module_lib->hasActive('expense') && $gr_can_feature('expenses')) {
...
if ($this->module_lib->hasActive('student_attendance') && $gr_can_feature('attendance')) {
...
if ($this->module_lib->hasActive('examination') && $gr_can_feature('exams')) {
...
?>
            ...
            <?php
if ($this->module_lib->hasActive('online_examination') && $gr_can_feature('online_exam')) {
...
?> <?php
if ($this->module_lib->hasActive('lesson_plan') && $gr_can_feature('lesson_plan')) {
...
?>
            <?php
if ($this->module_lib->hasActive('academics') && $gr_can_feature('academics')) {
...
?>
            ...
            <?php
if ($this->module_lib->hasActive('human_resource') && $gr_can_feature('human_resource')) {
...
if ($this->module_lib->hasActive('communicate') && $gr_can_feature('communicate')) {
...
<?php
if ($this->module_lib->hasActive('download_center') && $gr_can_feature('download_center')) {
...
if ($this->module_lib->hasActive('homework') && $gr_can_feature('homework')) {
...
if ($this->module_lib->hasActive('library') && $gr_can_feature('library')) {
...
if ($this->module_lib->hasActive('inventory') && $gr_can_feature('inventory')) {
...
if ($this->module_lib->hasActive('transport') && $gr_can_feature('transport')) {
...
if ($this->module_lib->hasActive('hostel') && $gr_can_feature('hostel')) {
...
if ($this->module_lib->hasActive('certificate') && $gr_can_feature('certificate')) {
...
?>
<?php
if ($this->module_lib->hasActive('alumni') && $gr_can_feature('alumni')) {
...
?>
            <?php
if ($this->module_lib->hasActive('reports') && $gr_can_feature('reports')) {
