...
<html <?php echo $this->customlib->getRTL(); ?>>
  ...
  <style type="text/css">
        span.flag-icon{text-orientation: mixed;}
        .main-header .logo,
        .main-header .logo:hover,
        .main-header .logo:focus {
            background: #ffffff !important;
            border-right: 1px solid rgba(6, 52, 95, 0.15);
        ...
        body.skin-blue .sidebar-menu > li.menu-open > a {
            ...
            border-left-color: #f68a00 !important;
        ...
        .box {
            border-top-color: #f68a00 !important;
            border-radius: 6px;
        ...
        .search-form .form-control:focus {
            border-color: #f68a00;
            box-shadow: 0 0 0 2px rgba(246, 138, 0, 0.15);
        }
        .main-header .navbar .topsidesearchbtn,
        .main-header .navbar .topsidesearchbtn:hover,
        .main-header .navbar .topsidesearchbtn:focus {
            background: transparent !important;
            color: #ffffff !important;
            box-shadow: none !important;
        }
        .main-header .navbar .topsidesearchbtn i {
            color: #ffffff !important;
        }
        .sessionul .dropdown-menu.verticalmenu {
            background: #ffffff !important;
            border: 1px solid #d6e3ee !important;
            border-top: 3px solid #f68a00 !important;
            box-shadow: 0 10px 24px rgba(6, 52, 95, 0.18) !important;
        }
        .sessionul .dropdown-menu.verticalmenu:before {
            border-right-color: #ffffff !important;
        }
        .sessionul .dropdown-menu.verticalmenu > li > a {
            color: #1f2d3d !important;
            background: #ffffff !important;
            font-family: inherit !important;
            font-weight: 600;
        }
        .sessionul .dropdown-menu.verticalmenu > li > a i {
            color: #06345f !important;
            margin-right: 8px;
        }
        .sessionul .dropdown-menu.verticalmenu > li > a:hover,
        .sessionul .dropdown-menu.verticalmenu > li > a:focus {
            color: #06345f !important;
            background: #eef5fb !important;
            border-left: 3px solid #f68a00;
        }
        .sessionul .dropdown-menu.verticalmenu > li > a:hover i,
        .sessionul .dropdown-menu.verticalmenu > li > a:focus i {
            color: #f68a00 !important;
        }
        .small-box,
        .info-box {
            border-radius: 8px !important;
            box-shadow: 0 10px 24px rgba(6, 52, 95, 0.10) !important;
            overflow: hidden;
        }
        .btn-primary,
        .btn-info {
            background: #06345f !important;
            border-color: #06345f !important;
        }
        .btn-primary:hover,
        .btn-info:hover {
            background: #0b416f !important;
            border-color: #0b416f !important;
        }
        .btn-success {
            background: #f68a00 !important;
            border-color: #f68a00 !important;
        }
        .form-control:focus {
            border-color: #f68a00 !important;
            box-shadow: 0 0 0 2px rgba(246, 138, 0, 0.14) !important;
        }
        .table > thead > tr > th,
