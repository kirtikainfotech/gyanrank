...
<body>
    ...
    <script src="../assets/js/apexcharts-candlestick-seriesdata.js"></script>

    <!-- Used For Candlestick With Cateory X-axis Chart-->
    <script src="../assets/js/apexcharts-dayjs.min.js"></script>

    <!-- Internal Apex Candlestick Charts JS -->
    <script src="../assets/js/apexcharts-candlestick.js"></script>
