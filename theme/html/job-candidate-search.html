...
<body>
                            ...
                            <div class="card custom-card">
                                <div class="card-body">
                                    ...
                                    <div class="d-flex mb-3 align-items-center flex-wrap gap-2">
                                        ...
                                        <div>
                                            <h5 class="fw-semibold mb-0 d-flex align-items-center"><a href="job-candidate-details.html"> Brenda Simpson <i class="bi bi-check-circle-fill text-success fs-16" data-bs-toggle="tooltip" title="Verified candidate"></i></a></h5>
                            ...
                            <div class="card custom-card">
                                <div class="card-body">
                                    ...
                                    <div class="d-flex mb-3 align-items-center flex-wrap gap-2">
                                        ...
                                        <div>
                                            <h5 class="fw-semibold mb-0 d-flex align-items-center"><a href="job-candidate-details.html"> Dwayne Stort <i class="bi bi-check-circle-fill text-success fs-16" data-bs-toggle="tooltip" title="Verified candidate"></i></a></h5>
                                            <div class="d-flex gap-2 flex-wrap">
                            ...
                            <div class="card custom-card">
                                <div class="card-body">
                                    ...
                                    <div class="d-flex mb-3 align-items-center flex-wrap gap-2">
                                        ...
                                        <div>
                                            <h5 class="fw-semibold mb-0 d-flex align-items-center"><a href="job-candidate-details.html"> Jasmine Kova <i class="bi bi-check-circle-fill text-success fs-16" data-bs-toggle="tooltip" title="Verified candidate"></i></a></h5>
                                            <div class="d-flex gap-2 flex-wrap">
                            ...
                            <div class="card custom-card">
                                <div class="card-body">
                                    ...
                                    <div class="d-flex mb-3 align-items-center flex-wrap gap-2">
                                        ...
                                        <div>
                                            <h5 class="fw-semibold mb-0 d-flex align-items-center"><a href="job-candidate-details.html"> Kiara Advain <i class="bi bi-check-circle-fill text-success fs-16" data-bs-toggle="tooltip" title="Verified candidate"></i></a></h5>
                                            <div class="d-flex gap-2 flex-wrap">
                            ...
                            <div class="card custom-card">
                                <div class="card-body">
                                    ...
                                    <div class="d-flex mb-3 align-items-center flex-wrap gap-2">
                                        ...
                                        <div>
                                            <h5 class="fw-semibold mb-0 d-flex align-items-center"><a href="job-candidate-details.html"> Json Taylor <i class="bi bi-check-circle-fill text-success fs-16" data-bs-toggle="tooltip" title="Verified candidate"></i></a></h5>
                                            <div class="d-flex gap-2 flex-wrap">
                            ...
                            <div class="card custom-card">
                                <div class="card-body">
                                    ...
                                    <div class="d-flex mb-3 align-items-center flex-wrap gap-2">
                                        ...
                                        <div>
                                            <h5 class="fw-semibold mb-0 d-flex align-items-center"><a href="job-candidate-details.html"> Diego Sanch <i class="bi bi-check-circle-fill text-success fs-16" data-bs-toggle="tooltip" title="Verified candidate"></i></a></h5>
                                            <div class="d-flex gap-2 flex-wrap">
    ...
    <!-- Search Candidate JS -->
    <script src="../assets/js/job-search-candidate.js"></script>
