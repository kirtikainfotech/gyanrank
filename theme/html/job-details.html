                ...
                <div class="container">
                                    ...
                                    <div class="d-flex flex-wrap align-items-top justify-content-between gap-2">
                                        <div>
                                            <div class="d-flex flex-wrap gap-2">
                                                ...
                                                <div>
                                                    <h4 class="fw-bold mb-0 d-flex align-items-center"><a href="javascript:void(0);">UI Developer - Fresher</a></h4>
                                                    <a href="javascript:void(0);" class="fw-semibold"><i class="bi bi-building"></i> Spruko Technologies .PVT.LTD</a>
                    ...
                    <div class="row">
                        <div class="col-xl-8">
                            <div class="card custom-card">
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-sm-4">
                                            <p class="fs-14 mb-2">
                                                <span class="avatar avatar-rounded me-2 bg-light text-default">
                            ...
                            <div class="card custom-card border bg-primary-transparent shadow-none">
                                <div class="card-body">
                                    <div class="row align-items-center">
                                        <div class="col-lg-6">
                                            <h5 class="fw-semibold mb-0">&#128400; Was this job fit for someone?</h5>
                                        </div>
                            ...
                            <div>
                                <h4 class="fw-semibold mb-0">Related Jobs</h4>
                                                    ...
                                                    <div class="card custom-card featured-jobs">
                                                        <div class="card-body">
                                                            ...
                                                            <div class="d-flex mb-3 flex-wrap gap-2">
                                                                ...
                                                                <div class="ms-2">
                                                                    <h5 class="fw-semibold mb-0 d-flex align-items-center"><a href="javascript:void(0);"> HTML Developer</a></h5>
                                                            ...
                                                            <div class="d-flex justify-content-between">
                                                                <h6 class="fw-semibold mb-0">$25,000 - $35,000</h6>
                                                                <a href="" class="text-primary fw-semibold fs-14">
                                                    ...
                                                    <div class="card custom-card featured-jobs">
                                                        <div class="card-body">
                                                            ...
                                                            <div class="d-flex flex-wrap gap-2 mb-3">
                                                                ...
                                                                <div class="ms-2">
                                                                    <h5 class="fw-semibold mb-0 d-flex align-items-center"><a href="javascript:void(0);"> React Developer</a></h5>
                                                    ...
                                                    <div class="card custom-card featured-jobs">
                                                        <div class="card-body">
                                                            ...
                                                            <div class="d-flex flex-wrap gap-2 mb-3">
                                                                ...
                                                                <div class="ms-2">
                                                                    <h5 class="fw-semibold mb-0 d-flex align-items-center"><a href="javascript:void(0);"> Vuejs Developer</a></h5>
                                                    ...
                                                    <div class="card custom-card featured-jobs">
                                                        <div class="card-body">
                                                            ...
                                                            <div class="d-flex flex-wrap gap-2 mb-3">
                                                                ...
                                                                <div class="ms-2">
                                                                    <h5 class="fw-semibold mb-0 d-flex align-items-center"><a href="javascript:void(0);"> Wordpress Developer</a></h5>
                        ...
                        <div class="col-xl-4">
                            <div class="card custom-card border">
                                    ...
                                    <ul class="list-group list-group-flush">
                                        <li class="list-group-item mb-2">
                                            <div class="d-sm-flex">
                                                ...
                                                <div class="ms-2 flex-grow-1">
                                                    <p class="fw-semibold fs-14 mb-1"><a href="javascript:void(0);"> React Lead Developer</a></p>
                                        ...
                                        <li class="list-group-item mb-2">
                                            <div class="d-sm-flex">
                                                ...
                                                <div class="ms-2 flex-grow-1">
                                                    <p class="fw-semibold fs-14 mb-1"><a href="javascript:void(0);"> HTML Developer - Fresher</a></p>
                                        ...
                                        <li class="list-group-item mb-2">
                                            <div class="d-sm-flex">
                                                ...
                                                <div class="ms-2 flex-grow-1">
                                                    <p class="fw-semibold fs-14 mb-1"><a href="javascript:void(0);"> Wordpress Developer - Remote</a></p>
                                        ...
                                        <li class="list-group-item">
                                            <div class="d-sm-flex">
                                                ...
                                                <div class="ms-2 flex-grow-1">
                                                    <p class="fw-semibold fs-14 mb-1"><a href="javascript:void(0);"> Vuejs Frontend Developer</a></p>
                                ...
                                <div class="card-footer">
                                    <a href="javascript:void(0);" class="text-primary fw-semibold fs-14 mt-2">
                                    ...
                                    <ul class="list-group list-group-flush">
                                        <li class="list-group-item mb-2">
                                            <div class="d-sm-flex">
                                                ...
                                                <div class="ms-2 flex-grow-1">
                                                    <p class="fw-semibold fs-14 mb-1"><a href="javascript:void(0);">Infratech PVT LTD</a></p>
                                        ...
                                        <li class="list-group-item mb-2">
                                            <div class="d-sm-flex">
                                                ...
                                                <div class="ms-2 flex-grow-1">
                                                    <p class="fw-semibold fs-14 mb-1"><a href="javascript:void(0);">Spruko Technologies PVT LTD</a></p>
                                        ...
                                        <li class="list-group-item mb-2">
                                            <div class="d-sm-flex">
                                                ...
                                                <div class="ms-2 flex-grow-1">
                                                    <p class="fw-semibold fs-14 mb-1"><a href="javascript:void(0);">Hardware Private Solutions </a></p>
                                        ...
                                        <li class="list-group-item mb-2">
                                            <div class="d-sm-flex">
                                                ...
                                                <div class="ms-2 flex-grow-1">
                                                    <p class="fw-semibold fs-14 mb-1"><a href="javascript:void(0);"> G Technical Solutions</a></p>
                            ...
                            <div class="card custom-card">
                                <div class="card-body">
                                    <div class="">
                                        <h5 class="fw-semibold mb-3">Get Latest Job Alerts</h5>
