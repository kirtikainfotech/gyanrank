                ...
                <div class="main-mail-container p-2 gap-2 d-flex">
                    <div class="mail-navigation border">
                        <div class="d-grid align-items-top p-3 border-bottom">
                            <button type="button" class="btn btn-success d-flex align-items-center justify-content-center" data-bs-toggle="modal"
                    ...
                    <div class="total-mails border">
                        <div class="p-3 d-flex align-items-center border-bottom">
                            ...
                            <button aria-label="button" type="button" class="btn btn-icon btn-light me-1 d-lg-none d-block total-mails-close" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Close">
                                <i class="ri-close-line"></i>
                            </button>
                            <div class="dropdown">
                                <button aria-label="button" class="btn btn-icon btn-light btn-wave waves-light" type="button"
                        ...
                        <div class="p-3 border-bottom">
                            <div class="input-group">
                                ...
                                <button aria-label="button" class="btn btn-light" type="button" id="button-addon2"><i class="ri-search-line text-muted"></i></button>
                            </div>
                        </div>
                                    ...
                                    <div class="d-flex align-items-top">
                                        ...
                                        <div class="flex-fill">
                                            ...
                                            <p class="mail-msg mb-0">
                                                ...
                                                <span
                                                    class="fs-11 text-muted text-wrap text-truncate">Lorem
                                                    ipsum dolor sit amet consectetur adipisicing elit
                                                    <button type="button" aria-label="button" class="btn p-0 lh-1 mail-starred true border-0 float-end">
                                ...
                                <li class="active">
                                    <div class="d-flex align-items-top">
                                        ...
                                        <div class="flex-fill">
                                            ...
                                            <p class="mail-msg mb-0">
                                                <span class="d-block mb-0 fw-semibold text-truncate">History of planets are discovered yesterday.</span>
                                                <span
                                                    class="fs-11 text-muted text-wrap text-truncate">Lorem
                                                    ipsum dolor sit amet consectetur adipisicing elit
                                                    <button type="button" aria-label="button" class="btn p-0 lh-1 mail-starred border-0 float-end">
                                                        <i class="ri-star-fill fs-14"></i>
                                                    </button>
                                                </span>
                                            </p>
                                ...
                                <li>
                                    <div class="d-flex align-items-top">
                                        ...
                                        <div class="flex-fill">
                                            ...
                                            <p class="mail-msg mb-0">
                                                <span class="d-block mb-0 fw-semibold text-truncate">Request for return of item ?</span>
                                                <span
                                                    class="fs-11 text-muted text-wrap text-truncate">Lorem
                                                    ipsum dolor sit amet consectetur adipisicing elit
                                                    <button type="button" aria-label="button" class="btn p-0 lh-1 mail-starred border-0 float-end">
                                ...
                                <li>
                                    <div class="d-flex align-items-top">
                                        ...
                                        <div class="flex-fill">
                                            ...
                                            <p class="mail-msg mb-0">
                                                <span class="d-block mb-0 fw-semibold text-truncate">Completion of work is pending</span>
                                                <span
                                                    class="fs-11 text-muted text-wrap text-truncate">Lorem
                                                    ipsum dolor sit amet consectetur adipisicing elit
                                                    <button aria-label="button" type="button" class="btn p-0 lh-1 mail-starred border-0 float-end">
                                                        <i class="ri-star-fill fs-14"></i>
                                                    </button>
                                                </span>
                                            </p>
                                ...
                                <li>
                                    <div class="d-flex align-items-top">
                                        ...
                                        <div class="flex-fill">
                                            ...
                                            <p class="mail-msg mb-0">
                                                <span class="d-block mb-0 fw-semibold text-truncate">Most Probable date of project completion</span>
                                                <span
                                                    class="fs-11 text-muted text-wrap text-truncate">Lorem
                                                    ipsum dolor sit amet consectetur adipisicing elit
                                                    <button aria-label="button" type="button" class="btn p-0 lh-1 mail-starred true border-0 float-end">
                                                        <i class="ri-star-fill fs-14"></i>
                                                    </button>
                                                </span>
                                            </p>
                                ...
                                <li>
                                    <div class="d-flex align-items-top">
                                        ...
                                        <div class="flex-fill">
                                            ...
                                            <p class="mail-msg mb-0">
                                                <span class="d-block mb-0 fw-semibold text-truncate">Life Insurance Corparation.</span>
                                                <span
                                                    class="fs-11 text-muted text-wrap text-truncate">Lorem
                                                    ipsum dolor sit amet consectetur adipisicing elit
                                                    <button aria-label="button" type="button" class="btn p-0 lh-1 mail-starred border-0 float-end">
                    ...
                    <div class="mails-information border">
                        <div class="mail-info-header d-flex flex-wrap gap-2 align-items-center">
                            ...
                            <div class="mail-action-icons">
                                <button aria-label="button" type="button" class="btn btn-icon btn-light" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Starred">
                                    <i class="ri-star-line"></i>
                                </button>
                                <button aria-label="button" type="button" class="btn btn-icon btn-light ms-1" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Archive">
                                    <i class="ri-inbox-archive-line"></i>
                                </button>
                                <button aria-label="button" type="button" class="btn btn-icon btn-light ms-1" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Report spam">
                                    <i class="ri-spam-2-line"></i>
                                </button>
                                <button aria-label="button" type="button" class="btn btn-icon btn-light ms-1" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Delete">
                                    <i class="ri-delete-bin-line"></i>
                                </button>
                                <button aria-label="button" type="button" class="btn btn-icon btn-light ms-1" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Reply">
                                    <i class="ri-reply-line"></i>
                                </button>
                            </div>
                            <div class="responsive-mail-action-icons">
                                <div class="dropdown">
                                    <button aria-label="button" type="button" class="btn btn-icon btn-light btn-wave waves-light waves-effect" data-bs-toggle="dropdown" aria-expanded="false">
                                        <i class="ti ti-dots-vertical"></i>
                                    </button>
                                    <ul class="dropdown-menu">
                                ...
                                <button aria-label="button" type="button" class="btn btn-icon btn-light ms-1 close-button">
                                    <i class="ri-close-line"></i>
                                </button>
                            </div>
                        </div>
                        <div class="mail-info-body p-4" id="mail-info-body">
                            ...
                            <div class="mail-attachments mb-4">
                                <div class="d-flex justify-content-between align-items-center">
                                    <div class="mb-0">
                                        <span class="fs-14 fw-semibold"><i class="ri-attachment-2 me-1 align-middle"></i>Attachments (1.8mb):</span>
                                    </div>
                                    <div>
                                        <button type="button" class="btn btn-sm btn-success-light">Download All</button>
                                    </div>
                                </div>
                                <div class="mt-2 d-flex flex-wrap">
                                    ...
                                    <a aria-label="anchor" href="javascript:void(0);" class="btn btn-icon btn-outline-light ms-2 btn-lg mb-1" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Image_012.jpeg">
                                        <i class="ri-attachment-2"></i>
                                    </a>
                                </div>
                            </div>
                            <div class="mb-3">
                                <span class="fs-14 fw-semibold"><i class="ri-reply-all-line me-1 align-middle d-inline-block"></i>Reply:</span>
                            </div>
                        ...
                        <div class="mail-info-footer d-flex flex-wrap gap-2 align-items-center justify-content-between">
                            <div>
                                <button aria-label="button" type="button" class="btn btn-icon btn-light" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Print">
                                    <i class="ri-printer-line"></i>
                                </button>
                                <button aria-label="button" type="button" class="btn btn-icon btn-light ms-1" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Mark as read">
                                    <i class="ri-mail-open-line"></i>
                                </button>
                                <button aria-label="button" type="button" class="btn btn-icon btn-light ms-1" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Reload">
                                    <i class="ri-refresh-line"></i>
                                </button>
                            </div>
                            <div>
                                <button aria-label="button" type="button" class="btn btn-secondary">
                                    <i class="ri-share-forward-line me-1 d-inline-block align-middle"></i>Forward
                                </button>
                                <button aria-label="button" type="button" class="btn btn-danger ms-1">
                    ...
                    <div class="mail-recepients border">
                        <div class="p-3 border-bottom">
                            <button aria-label="button" type="button" class="btn btn-light btn-icon rounded-pill" data-bs-toggle="tooltip" data-bs-placement="left" data-bs-title="Add Recepient"><i class="ri-add-line"></i></button>
                        </div>
                        <div class="p-3 d-flex flex-column align-items-center total-mail-recepients" id="mail-recepients">
                            <a aria-label="anchor" href="javascript:void(0);" class="mail-recepeint-person">
