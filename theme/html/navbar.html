            ...
            <div class="main-content app-content">
                <div class="container-fluid">
                    ...
                    <div class="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
                        <h1 class="page-title fw-semibold fs-18 mb-0">Navbar</h1>
                            ...
                            <div class="card custom-card">
                                ...
                                <div class="card-body">
                                    <nav class="navbar bg-light mb-3">
                                        <div class="container-fluid">
                                            <a aria-label="anchor" class="navbar-brand" href="javascript:void(0);"><img src="../assets/images/brand-logos/toggle-logo.png" alt=""></a>
                                        </div>
                                    </nav>
                                    <nav class="navbar bg-light">
                                        <div class="container-fluid">
                                            <span class="navbar-brand mb-0 h1"><img src="../assets/images/brand-logos/toggle-logo.png" alt=""></span>
                                        </div>
                                    </nav>
                                </div>
                            </div>
                        ...
                        <div class="col-xl-12">
                            <div class="card custom-card">
                                ...
                                <div class="card-body">
                                    ...
                                    <nav class="navbar bg-light mb-3">
                                        <div class="container-fluid">
                                            <a aria-label="anchor" class="navbar-brand"><img src="../assets/images/brand-logos/toggle-logo.png" alt=""></a>
                                            <form class="d-flex" role="search">
                                                <input class="form-control me-2" type="search" placeholder="Search"
                                                    aria-label="Search">
                                                <button class="btn btn-primary" type="submit">Search</button>
                                    ...
                                    <h6 class="mb-3 fw-semibold">Input groups in navbar forms</h6>
                                    <nav class="navbar bg-light mb-3">
                                        <div class="container-fluid">
                                    ...
                                    <h6 class="mb-3 fw-semibold"> Variation buttons are supported as part of the navbar forms</h6>
                                    <nav class="navbar bg-light">
                                        <form class="container-fluid justify-content-start">
                                            <button class="btn btn-primary m-1" type="submit">Main
                                                button</button>
                            ...
                            <div class="card custom-card">
                                ...
                                <div class="card-body">
                                    ...
                                    <nav class="navbar navbar-expand-lg navbar-secondary mb-3">
                                        <div class="container-fluid">
                                            <a aria-label="anchor" class="navbar-brand" href="javascript:void(0);"><img src="../assets/images/brand-logos/toggle-dark.png" alt=""></a>
                                            <button class="navbar-toggler" type="button" data-bs-toggle="collapse"
