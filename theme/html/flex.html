            ...
            <div class="main-content app-content">
                <div class="container-fluid">
                    ...
                    <div class="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
                        <h1 class="page-title fw-semibold fs-18 mb-0">Flex</h1>
                                ...
                                <div class="card-body">
                                    <div class="d-sm-flex mb-3">
                                        <div class="flex-shrink-0 mb-3 mb-sm-0">
                                            <img class="bd-placeholder-img card-img w-10 h-10" src="../assets/images/faces/6.jpg" alt="img">
                                        </div>
                                    ...
                                    <div class="d-sm-flex align-items-center">
                                        <div class="flex-shrink-0 mb-3 mb-sm-0">
                                            <img class="bd-placeholder-img card-img avatar-xl" src="../assets/images/faces/15.jpg" alt="img">
                                        </div>
                                        <div class="flex-grow-1 ms-3">
