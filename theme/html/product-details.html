                                    ...
                                    <div class="col-xxl-3 col-xl-12">
                                        <div class="row">
                                                ...
                                                <div class="swiper swiper-preview-details bg-light product-details-page">
                                                    <div class="swiper-wrapper">
                                                        <div class="swiper-slide" id="img-container">
                                                            <img class="img-fluid" src="../assets/images/ecommerce/png/15.png" alt="img">
                                                        </div>
                                                        <div class="swiper-slide image-container">
                                                            <img class="img-fluid" src="../assets/images/ecommerce/png/13.png" alt="img">
                                                        </div>
                                                        <div class="swiper-slide image-container">
                                                            <img class="img-fluid" src="../assets/images/ecommerce/png/14.png" alt="img">
                                                        </div>
                                                        <div class="swiper-slide image-container">
                                                            <img class="img-fluid" src="../assets/images/ecommerce/png/17.png" alt="img">
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="col-xxl-12 col-xl-6 col-lg-6 col-md-6 col-sm-12 d-md-block d-none">
                                                <p class="fs-15 fw-semibold mb-2">Similar Products :</p>
                                                <div class="table-responsive">
                                                    <table class="table table-bordered text-nowrap">
                                                        <tbody>
                                                                ...
                                                                <td>
                                                                    <a href="javascript:void(0);">
                                                                        <div class="d-flex align-items-top">
                                                                            ...
                                                                            <div class="flex-fill">
                                                                                <p class="mb-1 fs-14 fw-semibold similar-product-name text-truncate">Omega watch series 3</p>
                                                                                <p class="mb-0">
                                                                                    <span class="badge bg-success">4.4<i class="ri-star-s-fill ms-1"></i></span>
                                                                ...
                                                                <td>
                                                                    <a href="javascript:void(0);">
                                                                        <div class="d-flex align-items-top">
                                                                            ...
                                                                            <div class="flex-fill">
                                                                                <p class="mb-1 fs-14 fw-semibold similar-product-name text-truncate">Strap on watch(White)</p>
                                                                                <p class="mb-0">
                                                                                    <span class="badge bg-success">3.8<i class="ri-star-s-fill ms-1"></i></span>
                                                                ...
                                                                <td>
                                                                    <a href="javascript:void(0);">
                                                                        <div class="d-flex align-items-top">
                                                                            ...
                                                                            <div class="flex-fill">
                                                                                <p class="mb-1 fw-semibold similar-product-name text-truncate">Orange watch series 3</p>
                                                                                <p class="mb-0">
                                                                                    <span class="badge bg-success">4.1<i class="ri-star-s-fill ms-1"></i></span>
                                                                ...
                                                                <td>
                                                                    <a href="javascript:void(0);">
                                                                        <div class="d-flex align-items-top">
                                                                            ...
                                                                            <div class="flex-fill">
                                                                                <p class="mb-1 fw-semibold similar-product-name text-truncate">Omega watch special edition</p>
                                                                                <p class="mb-0">
                                                                                    <span class="badge bg-success">3.8<i class="ri-star-s-fill ms-1"></i></span>
                                                                ...
                                                                <td>
                                                                    <a href="javascript:void(0);">
                                                                        <div class="d-flex align-items-top">
                                                                            ...
                                                                            <div class="flex-fill">
                                                                                <p class="mb-1 fw-semibold similar-product-name text-truncate">Fassil smart watch(45mm)</p>
                                                                                <p class="mb-0">
                                                                                    <span class="badge bg-success">4.5<i class="ri-star-s-fill ms-1"></i></span>
                                                                ...
                                                                <td>
                                                                    <a href="javascript:void(0);">
                                                                        <div class="d-flex align-items-top">
                                                                            ...
                                                                            <div class="flex-fill">
                                                                                <p class="mb-1 fw-semibold similar-product-name text-truncate">Electro viintage watch(40mm)</p>
                                                                                <p class="mb-0">
                                                                                    <span class="badge bg-success">4.1<i class="ri-star-s-fill ms-1"></i></span>
                                                                ...
                                                                <td>
                                                                    <a href="javascript:void(0);">
                                                                        <div class="d-flex align-items-top">
                                                                            ...
                                                                            <div class="flex-fill">
                                                                                <p class="mb-1 fw-semibold similar-product-name text-truncate">Bolts smart watch(Amoled)</p>
                                                                                <p class="mb-0">
                                                                                    <span class="badge bg-success">4.3<i class="ri-star-s-fill ms-1"></i></span>
                                                            ...
                                                            <tr>
                                                                <td class="d-grid">
                                                                    <button class="btn btn-primary-light">View All Products</button>
                                                                </td>
                                                            </tr>
                                                        </tbody>
                                                    </table>
                                    ...
                                    <div class="col-xxl-9 col-xl-12">
                                        <div class="row gx-5">
                                                ...
                                                <div>
                                                    ...
                                                    <div class="row mb-4">
                                                        ...
                                                        <div class="col-xxl-4 col-xl-6 col-lg-6 col-md-6 col-sm-12 mt-xxl-0 mt-3">
                                                            <p class="mb-2 fs-15 fw-semibold">Watch Type</p>
                                                            <div class="btn-group" role="group" aria-label="Basic radio toggle button group">
                                                                <input type="radio" class="btn-check" name="select-type" id="type1" checked="">
                                                                <label class="btn btn-sm btn-outline-light text-default" for="type1">GPS</label>
                                                                <input type="radio" class="btn-check" name="select-type" id="type2">
                                                                <label class="btn btn-sm btn-outline-light text-default" for="type2">GPS+Cellular</label>
                                                            </div>
                                                        </div>
                                                        <div class="col-xxl-5 col-xl-6 col-lg-6 col-md-6 col-sm-12 mt-xxl-0 mt-3">
                                                            <p class="mb-2 fs-15 fw-semibold">Strap Material</p>
                                                            <div class="btn-group" role="group" aria-label="Basic radio toggle button group">
                                                                <input type="radio" class="btn-check" name="strap-material" id="strap1" checked="">
                                                                <label class="btn btn-sm btn-outline-light text-default" for="strap1">Leather</label>
                                                                <input type="radio" class="btn-check" name="strap-material" id="strap2">
                                                                <label class="btn btn-sm btn-outline-light text-default" for="strap2">Stainless steel</label>
                                                                <input type="radio" class="btn-check" name="strap-material" id="strap3">
                                                                <label class="btn btn-sm btn-outline-light text-default" for="strap3">Synthetic</label>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="mb-4">
                                                    ...
                                                    <div class="mb-4">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-xl-6 col-xl-6 col-lg-6 col-md-6 col-sm-12 mt-md-0 mt-3">
                                                                <p class="fs-15 fw-semibold mb-2">Dial Size(in mm) :</p>
                                                                <p class="mb-0 d-flex">
                                            ...
                                            <div class="col-xl-4 mt-xxl-0 mt-3">
                                                <div class="mb-5">
                                                    <div class="offer-promotion mb-4">
                                                        <div class="d-xxl-flex d-lg-block d-sm-flex flex-wrap justify-content-between align-items-center gap-2">
                                                            <div class="text-warning">Use Code <span class="promotion-code fw-semibold">FIRBUY</span><a class="fs-10 text-warning ms-1 d-inline-block" href="javascript:void(0);">T&C.</a></div>
                                                            <div class="mt-sm-0 mt-2">
                                                                <span class="bg-warning-transparent text-default fs-12 offer-details mb-0">Get it for <span class="text-success fw-semibold">$1,099</span></span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="mb-4">
                                                    ...
                                                    <div class="mb-4">
                                                        <ul class="list-group">
                                                            <li class="list-group-item">
                                                                <div class="lh-1">
                                                                    <span class="text-success fw-semibold fs-14 d-flex align-items-center"><i class="ti ti-discount-2 fs-18 me-1"></i>3 Available offers</span>
                                                                </div>
                                                            </li>
                                                            <li class="list-group-item">
                                                                <div class="fs-12 text-default">
                                                                    <span class="text-success me-1 fw-semibold">Bank Offer:</span><span class="flex-fill">5% off upto 500 on min purchase of $999<a href="javascript:void(0);" class="text-primary ms-1">View.</a></span>
                                                                </div>
                                                            </li>
                                                            <li class="list-group-item">
                                                                <div class="fs-12 text-default">
                                                                    <span class="text-success me-1 fw-semibold">Emi:</span><span class="flex-fill">No cost emi on selected bank card on min purchase of $1,499<a href="javascript:void(0);" class="text-primary ms-1">View.</a></span>
                                                                </div>
                                                            </li>
                                                            <li class="list-group-item p-0">
                                                                <ul class="collapse list-group" id="offers-more">
                                                                    <li class="list-group-item border-0 border-bottom">
                                                                        <div class="fs-12 text-default">
                                                                            <span class="text-success me-1 fw-semibold">Free Delivery:</span><span class="flex-fill">Free delivery on first order<a href="javascript:void(0);" class="text-primary ms-1">View.</a></span>
                                                                        </div>
                                                                    </li>
                                                                    <li class="list-group-item border-0">
                                                                        <div class="fs-12 text-default">
                                                                            <span class="text-success me-1 fw-semibold">Promotion:</span><span class="flex-fill">Offer upto 30% on grosery on purchase of this item<a href="javascript:void(0);" class="text-primary ms-1">T&C.</a></span>
                                                                        </div>
                                                                    </li>
                                                                </ul>
                                                            </li>
                                                    ...
                                                    <div class="mb-4">
                                                        <p class="mb-0 fw-semibold">Returns:</p>
                                                    ...
                                                    <div class="d-grid">
                                                        <a href="cart.html" class="btn btn-primary mb-2">Add To Cart</a>
                                                        <a href="checkout.html" class="btn btn-success mb-2">Buy Now</a>
                                                        <a href="wishlist.html" class="btn btn-light">Add To Wishlist</a>
                                                    </div>
                                                </div>
                                                <div class="text-center">
                                                    <a href="javascript:void(0);">
                                                        <img src="../assets/images/ecommerce/png/25.png" alt="" class="img-fluid rounded bg-light">
                                                    </a>
                                                </div>
                                            </div>
                                        </div>
