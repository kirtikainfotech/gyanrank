                ...
                <div class="row justify-content-center">
                    <div class="col-xl-10">
                        <div class="card custom-card overflow-hidden">
                            <div class="card-body">
                                <span class="nft-details-auction-time shadow">24hrs : 32mins : 11sec</span>
                                <div class="row gx-5">
                                    <div class="col-xxl-4 col-xl-12">
                                        <div class="row">
                                                ...
                                                <div class="swiper swiper-preview-details bg-light product-details-page">
                                                    <div class="swiper-wrapper">
                                                        <div class="swiper-slide" id="img-container">
                                                            <img class="img-fluid" src="../assets/images/nft-images/32.png" alt="img">
                                                        </div>
                                                        <div class="swiper-slide image-container">
                                                            <img class="img-fluid" src="../assets/images/nft-images/31.png" alt="img">
                                                        </div>
                                                        <div class="swiper-slide image-container">
                                                            <img class="img-fluid" src="../assets/images/nft-images/30.png" alt="img">
                                                        </div>
                                                        <div class="swiper-slide image-container">
                                                            <img class="img-fluid" src="../assets/images/nft-images/33.png" alt="img">
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="col-xxl-12 col-sm-12 d-md-block d-none">
                                                <p class="fs-15 fw-semibold mb-2">Featured NFT's :</p>
                                                <div class="table-responsive overflow-hidden">
                                                    <table class="table table-bordered text-nowrap">
                                                        <tbody>
                                                                ...
                                                                <td>
                                                                    <a href="javascript:void(0);">
                                                                        <div class="d-flex align-items-top">
                                                                            ...
                                                                            <div class="flex-fill">
                                                                                <p class="mb-1 fs-14 fw-semibold similar-product-name text-truncate">Neo-Nebulae</p>
                                                                                <p class="mb-0">
                                                                                    <span class="badge bg-success">13.2k<i class="ri-heart-3-fill align-middle ms-1"></i></span>
                                                                                    <span class="text-muted ms-1">(13,256)</span>
                                                                                </p>
                                                                            </div>
                                                                            <div class="text-center">
                                                                                <p class="mb-0 fs-16 fw-semibold">
                                                                                    <span class="avatar avatar-xs avatar-rounded p-1"><img src="../assets/images/crypto-currencies/regular/Ethereum.svg" alt=""></span>1.099
                                                                                </p>
                                                                                <p class="mb-0 text-muted">
                                                                                    <s><span class="avatar avatar-xs avatar-rounded p-1"><img src="../assets/images/crypto-currencies/regular/Ethereum.svg" alt=""></span>1.759</s>
                                                                                </p>
                                                                            </div>
                                                                        </div>
                                                                    </a>
                                                                ...
                                                                <td>
                                                                    <a href="javascript:void(0);">
                                                                        <div class="d-flex align-items-top">
                                                                            ...
                                                                            <div class="flex-fill">
                                                                                <p class="mb-1 fs-14 fw-semibold similar-product-name text-truncate">Chromatic Chaos</p>
                                                                                <p class="mb-0">
                                                                                    <span class="badge bg-success">5.2k<i class="ri-heart-3-fill align-middle ms-1"></i></span>
                                                                                    <span class="text-muted ms-1">(5,289)</span>
                                                                                </p>
                                                                            </div>
                                                                            <div class="text-center">
                                                                                <p class="mb-0 fs-16 fw-semibold">
                                                                                    <span class="avatar avatar-xs avatar-rounded p-1"><img src="../assets/images/crypto-currencies/regular/Ethereum.svg" alt=""></span>7.99
                                                                                </p>
                                                                                <p class="mb-0 text-muted">
                                                                                    <s><span class="avatar avatar-xs avatar-rounded p-1"><img src="../assets/images/crypto-currencies/regular/Ethereum.svg" alt=""></span>12.99</s>
                                                                                </p>
                                                                            </div>
                                                                        </div>
                                                                    </a>
                                                                ...
                                                                <td>
                                                                    <a href="javascript:void(0);">
                                                                        <div class="d-flex align-items-top">
                                                                            ...
                                                                            <div class="flex-fill">
                                                                                <p class="mb-1 fw-semibold similar-product-name text-truncate">Surreal Synthesis</p>
                                                                                <p class="mb-0">
                                                                                    <span class="badge bg-success">2.4k<i class="ri-heart-3-fill align-middle ms-1"></i></span>
                                                                                    <span class="text-muted ms-1">(2,476)</span>
                                                                                </p>
                                                                            </div>
                                                                            <div class="text-center">
                                                                                <p class="mb-0 fs-16 fw-semibold">
                                                                                    <span class="avatar avatar-xs avatar-rounded p-1"><img src="../assets/images/crypto-currencies/regular/Ethereum.svg" alt=""></span>1.499
                                                                                </p>
                                                                                <p class="mb-0 text-muted">
                                                                                    <s><span class="avatar avatar-xs avatar-rounded p-1"><img src="../assets/images/crypto-currencies/regular/Ethereum.svg" alt=""></span>2.599</s>
                                                                                </p>
                                                                            </div>
                                                                        </div>
                                                                    </a>
                                                                ...
                                                                <td>
                                                                    <a href="javascript:void(0);">
                                                                        <div class="d-flex align-items-top">
                                                                            ...
                                                                            <div class="flex-fill">
                                                                                <p class="mb-1 fw-semibold similar-product-name text-truncate">Virtual Visions</p>
                                                                                <p class="mb-0">
                                                                                    <span class="badge bg-success">1.8k<i class="ri-heart-3-fill align-middle ms-1"></i></span>
                                                                                    <span class="text-muted ms-1">(1,893)</span>
                                                                                </p>
                                                                            </div>
                                                                            <div class="text-center">
                                                                                <p class="mb-0 fs-16 fw-semibold">
                                                                                    <span class="avatar avatar-xs avatar-rounded p-1"><img src="../assets/images/crypto-currencies/regular/Ethereum.svg" alt=""></span>2.299
                                                                                </p>
                                                                                <p class="mb-0 text-muted">
                                                                                    <s><span class="avatar avatar-xs avatar-rounded p-1"><img src="../assets/images/crypto-currencies/regular/Ethereum.svg" alt=""></span>3.299</s>
                                                                                </p>
                                                                            </div>
                                                                        </div>
                                                                    </a>
                                                                ...
                                                                <td>
                                                                    <a href="javascript:void(0);">
                                                                        <div class="d-flex align-items-top">
                                                                            ...
                                                                            <div class="flex-fill">
                                                                                <p class="mb-1 fw-semibold similar-product-name text-truncate">Pixel Prism</p>
                                                                                <p class="mb-0">
                                                                                    <span class="badge bg-success">12.9k<i class="ri-heart-3-fill align-middle ms-1"></i></span>
                                                                                    <span class="text-muted ms-1">(12,923)</span>
                                                                                </p>
                                                                            </div>
                                                                            <div class="text-center">
                                                                                <p class="mb-0 fs-16 fw-semibold">
                                                                                    <span class="avatar avatar-xs avatar-rounded p-1"><img src="../assets/images/crypto-currencies/regular/Ethereum.svg" alt=""></span>8.99
                                                                                </p>
                                                                                <p class="mb-0 text-muted">
                                                                                    <s><span class="avatar avatar-xs avatar-rounded p-1"><img src="../assets/images/crypto-currencies/regular/Ethereum.svg" alt=""></span>12.99</s>
                                                                                </p>
                                                                ...
                                                                <td>
                                                                    <a href="javascript:void(0);">
                                                                        <div class="d-flex align-items-top">
                                                                            ...
                                                                            <div class="flex-fill">
                                                                                <p class="mb-1 fw-semibold similar-product-name text-truncate">Electric Euphoria</p>
                                                                                <p class="mb-0">
                                                                                    <span class="badge bg-success">4.5k<i class="ri-heart-3-fill align-middle ms-1"></i></span>
                                                                                    <span class="text-muted ms-1">(453)</span>
                                                                                </p>
                                                                            </div>
                                                                            <div class="text-center">
                                                                                <p class="mb-0 fs-16 fw-semibold">
                                                                                    <span class="avatar avatar-xs avatar-rounded p-1"><img src="../assets/images/crypto-currencies/regular/Ethereum.svg" alt=""></span>1.799
                                                                                </p>
                                                                                <p class="mb-0 text-muted">
                                                                                    <s><span class="avatar avatar-xs avatar-rounded p-1"><img src="../assets/images/crypto-currencies/regular/Ethereum.svg" alt=""></span>2.499</s>
                                                                                </p>
                                                                            </div>
                                                                        </div>
                                                                    </a>
                                                                ...
                                                                <td>
                                                                    <a href="javascript:void(0);">
                                                                        <div class="d-flex align-items-top">
                                                                            ...
                                                                            <div class="flex-fill">
                                                                                <p class="mb-1 fw-semibold similar-product-name text-truncate">Virtual Veracity</p>
                                                                                <p class="mb-0">
                                                                                    <span class="badge bg-success">1.8k<i class="ri-heart-3-fill align-middle ms-1"></i></span>
                                                                                    <span class="text-muted ms-1">(1,874)</span>
                                                                                </p>
                                                                            </div>
                                                                            <div class="text-center">
                                                                                <p class="mb-0 fs-16 fw-semibold">
                                                                                ...
                                                                                <p class="mb-0 text-muted">
                                                                                    <s><span class="avatar avatar-xs avatar-rounded p-1"><img src="../assets/images/crypto-currencies/regular/Ethereum.svg" alt=""></span>2.999</s>
                                                                                </p>
                                                                            </div>
                                                                        </div>
                                                                    </a>
                                                            ...
                                                            <tr>
                                                                <td class="d-grid">
                                                                    <button class="btn btn-primary-light">View All NFT's</button>
                                                                </td>
                                                            </tr>
                                                        </tbody>
                                                    </table>
                                    ...
                                    <div class="col-xxl-8 col-xl-12">
                                        <div class="row gx-5">
                                            <div class="col-xl-12 mt-xxl-0 mt-3">
                                                <div>
                                                    <p class="fs-18 fw-semibold mb-0">Digital Dream Space - NFT Digital Art</p>
                                                    <p class="fs-18 mb-4">
                                                        <i class="ri-heart-3-fill text-danger align-middle"></i>
                                                        <span class="fw-semibold text-muted"><a class="text-info fs-14" href="javascript:void(0);">(2.4k Likes)</a></span>
                                                    </p>
                                                    <div class="row mb-4">
                                                        <div class="col-xxl-3 col-xl-12">
                                                            <p class="mb-1 lh-1 fs-11 text-success fw-semibold">Special Offer</p>
                                                            <p class="mb-1"><span class="h3"><span class="avatar avatar-sm avatar-rounded p-1 bg-light me-2"><img src="../assets/images/crypto-currencies/regular/Ethereum.svg" alt=""></span>1.299<sup class="fs-14">.00</sup></span><span class="ms-3 badge bg-danger-transparent">50% Off</span></p>
                                                            <p class="mb-0 text-muted fs-12">M.R.P-<s>ETH2,599.00</s></p>
                                                        </div>
                                                        <div class="col-xxl-4 col-xl-6 col-lg-6 col-md-6 col-sm-12 mt-xxl-0 mt-3">
                                                            <p class="mb-2 fs-15 fw-semibold">Creator</p>
                                                            <div class="d-flex align-items-center fw-semibold">
                                                                <span class="avatar avatar-xs avatar-rounded lh-1 me-1"><img src="../assets/images/faces/9.jpg" alt=""></span>
                                                                Json Taylor
                                                            </div>
                                                        </div>
                                                        <div class="col-xxl-5 col-xl-6 col-lg-6 col-md-6 col-sm-12 mt-xxl-0 mt-3">
                                                            <p class="mb-2 fs-15 fw-semibold">Published</p>
                                                            <span class="d-block fw-semibold">24, Jul 2023 - 12:45PM</span>
                                                        </div>
                                                    </div>
                                                    <div class="mb-4">
                                                        ...
                                                        <div class="row justify-content-center">
                                                            <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-4 col-sm-4 col-12">
                                                                <div class="ecommerce-assurance">
                                                                    ...
                                                                    <p class="fs-14 fw-semibold mb-0">Featured NFT</p>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="col-xxl-8 col-xl-12 col-lg-12 col-md-12 col-sm-12 mt-xxl-0 mt-3">
                                                                <div class="border p-3">
                                                                    <div class="d-sm-flex d-block align-items-top mb-3">
                                                                        <div class="d-flex flex-fill">
                                                                            ...
                                                                            <div class="lh-1 me-2">
                                                                                ...
                                                                                <div class="mb-1">
                                                                                    <i class="ri-star-fill align-middle text-warning align-middle fs-12"></i>
                                                                                    <i class="ri-star-fill align-middle text-warning align-middle fs-12"></i>
                                                                                    <i class="ri-star-fill align-middle text-warning align-middle fs-12"></i>
                                                                                    <i class="ri-star-fill align-middle text-warning align-middle fs-12"></i>
                                                                    ...
                                                                    <div class="ps-sm-4 ps-0 mb-3">
                                                                        <p class="fw-semibold mb-1 ps-2">Truely amazing NFT&#128512;</p>
                                                                        <p class="mb-0 fs-12 text-muted ps-2">Digital Dreamspace is a truly captivating NFT that takes you on an unforgettable journey. The artwork's vivid colors and ethereal elements create a sense of tranquility and wonder </p>
                                                                    </div>
