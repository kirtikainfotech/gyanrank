                                    ...
                                    <table class="table table-bordered text-nowrap">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="wishlist.html" class="btn btn-icon btn-success me-1" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Add To Wishlist"><i class="ri-heart-line"></i></a>
                                                    <button class="btn btn-icon btn-danger btn-delete" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Remove From cart">
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div>
                                                            ...
                                                            <div class="mb-1">
                                                                <span class="me-1">Color:</span><span class="fw-semibold text-muted">Blue<span class="badge bg-secondary ms-3">25% discount</span></span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </td>
                                                ...
                                                <td class="product-quantity-container">
                                                    <div class="input-group rounded flex-nowrap">
                                                        <button class="btn btn-icon btn-light input-group-text flex-fill product-quantity-minus border-end-0" ><i class="ri-subtract-line"></i></button>
                                                        <input type="text" class="form-control form-control-sm text-center w-100" aria-label="quantity" id="product-quantity1" value="1">
                                                        <button class="btn btn-icon btn-light input-group-text flex-fill product-quantity-plus border-start-0" ><i class="ri-add-line"></i></button>
                                                    </div>
                                                </td>
                                                <td>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div>
                                                            ...
                                                            <div class="mb-1">
                                                                <span class="me-1">Size:</span><span class="fw-semibold text-muted">44mm dial</span>
                                                            </div>
                                                            <div class="mb-1">
                                                                <span class="me-1">Color:</span><span class="fw-semibold text-muted">Bronze<span class="badge bg-success-transparent ms-3">On Offer</span></span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </td>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div>
                                                            ...
                                                            <div class="mb-1">
                                                                <span class="me-1">Color:</span><span class="fw-semibold text-muted">Light Pink<span class="badge bg-success-transparent ms-3">On Offer</span></span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td class="product-quantity-container">
                                                    <div class="input-group rounded flex-nowrap">
                                                        <button class="btn btn-icon btn-light input-group-text flex-fill product-quantity-minus border-end-0"><i class="ri-subtract-line"></i></button>
                                                        <input type="text" class="form-control form-control-sm text-center w-100" aria-label="quantity" id="product-quantity4" value="1">
                                                        <button class="btn btn-icon btn-light input-group-text flex-fill product-quantity-plus border-start-0"><i class="ri-add-line"></i></button>
                                                    </div>
                                                </td>
                                                <td>
                        ...
                        <div class="card custom-card">
                            ...
                            <div class="card-body p-0">
                                ...
                                <div class="p-3 d-grid">
                                    <a href="checkout.html" class="btn btn-primary btn-wave mb-2">Proceed To Checkout</a>
                                    <a href="products.html" class="btn btn-light btn-wave">Countinue Shopping</a>
                                </div>
                            </div>
                        </div>
                    </div>
