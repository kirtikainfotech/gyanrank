        ...
        <div class="main-content app-content">
            <div class="container-fluid">
                ...
                <div class="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
                    <h1 class="page-title fw-semibold fs-18 mb-0">Borders</h1>
                ...
                <div class="row">
                    <div class="col-xl-6">
                        <div class="card custom-card">
                            ...
                            <div class="card-body">
                                <img src="../assets/images/media/media-58.jpg" class="bd-placeholder-img rounded" alt="...">
                            ...
                            <div class="card-footer d-none border-top-0">
<!-- Prism Code -->
<pre class="language-html"><code class="language-html">&lt;img src="../assets/images/media/media-58.jpg" class="bd-placeholder-img rounded" alt="..."&gt;
    &lt;img src="../assets/images/media/media-58.jpg" class="bd-placeholder-img rounded-top" alt="..."&gt;
    &lt;img src="../assets/images/media/media-58.jpg" class="bd-placeholder-img rounded-end" alt="..."&gt;
    &lt;img src="../assets/images/media/media-58.jpg" class="bd-placeholder-img rounded-bottom" alt="..."&gt;
    &lt;img src="../assets/images/media/media-58.jpg" class="bd-placeholder-img rounded-start" alt="..."&gt;
    &lt;img src="../assets/images/media/media-58.jpg" class="bd-placeholder-img rounded-circle" alt="..."&gt;
    &lt;img src="../assets/images/media/media-58.jpg" class="bd-placeholder-img  rounded-pill" alt="..."&gt;</code></pre>
<!-- Prism Code -->
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-6">
                        <div class="card custom-card">
                            ...
                            <div class="card-body">
                                ...
                                <img src="../assets/images/media/media-58.jpg" class="bd-placeholder-img bd-placeholder-img rounded-1" alt="...">
                                <img src="../assets/images/media/media-58.jpg" class="bd-placeholder-img bd-placeholder-img rounded-2" alt="...">
                                <img src="../assets/images/media/media-58.jpg" class="bd-placeholder-img bd-placeholder-img rounded-3" alt="...">
                                <img src="../assets/images/media/media-58.jpg" class="bd-placeholder-img bd-placeholder-img rounded-4" alt="...">
                                <img src="../assets/images/media/media-58.jpg" class="bd-placeholder-img bd-placeholder-img rounded-5" alt="...">
                            </div>
                            <div class="card-footer d-none border-top-0">
<!-- Prism Code -->
<pre class="language-html"><code class="language-html">&lt;img src="../assets/images/media/media-58.jpg" class="bd-placeholder-img bd-placeholder-img rounded-0" alt="..."&gt;
    &lt;img src="../assets/images/media/media-58.jpg" class="bd-placeholder-img bd-placeholder-img rounded-1" alt="..."&gt;
    &lt;img src="../assets/images/media/media-58.jpg" class="bd-placeholder-img bd-placeholder-img rounded-2" alt="..."&gt;
    &lt;img src="../assets/images/media/media-58.jpg" class="bd-placeholder-img bd-placeholder-img rounded-3" alt="..."&gt;
    &lt;img src="../assets/images/media/media-58.jpg" class="bd-placeholder-img bd-placeholder-img rounded-4" alt="..."&gt;
    &lt;img src="../assets/images/media/media-58.jpg" class="bd-placeholder-img bd-placeholder-img rounded-5" alt="..."&gt;</code></pre>
<!-- Prism Code -->
                            </div>
                        </div>
                    </div>
