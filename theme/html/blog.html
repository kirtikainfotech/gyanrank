                                ...
                                <div id="carouselExampleSlidesOnly" class="carousel slide carousel-fade" data-bs-ride="carousel">
                                    <div class="carousel-inner">
                                        <div class="carousel-item active" data-bs-interval="2000">
                                            <a href="javascript:void(0);">
                                                <img src="../assets/images/media/media-70.jpg" class="d-block w-100" alt="...">
                                                <div class="carousel-caption blog-caption text-start">
                                                    ...
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div class="fw-semibold">Json Taylor - <span class="fs-11 op-7 fw-normal">12,Dec 2022 - 04:34PM</span></div>
                                                    </div>
                                                </div>
                                            </a>
                                        </div>
                                        <div class="carousel-item" data-bs-interval="2000">
                                            <a href="javascript:void(0);">
                                                <img src="../assets/images/media/media-71.jpg" class="d-block w-100" alt="...">
                                                <div class="carousel-caption blog-caption text-start">
                                                    ...
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div class="fw-semibold">Elisha Keens - <span class="fs-11 op-7 fw-normal">23,Dec 2022 - 11:27AM</span></div>
                                                    </div>
                                                </div>
                                            </a>
                                        </div>
                                        <div class="carousel-item" data-bs-interval="2000">
                                            <a href="javascript:void(0);">
                                                <img src="../assets/images/media/media-72.jpg" class="d-block w-100" alt="...">
                                                <div class="carousel-caption blog-caption text-start">
                                                    ...
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div class="fw-semibold">Melissa Blue - <span class="fs-11 op-7 fw-normal">16,Dec 2022 - 9:45AM</span></div>
                                                    </div>
                                                </div>
                                            </a>
                                        </div>
                        ...
                        <div class="row">
                            <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6 col-sm-6">
                                <div class="card custom-card">
                                    <a href="javascript:void(0);">
                                        <img src="../assets/images/media/media-36.jpg" class="card-img-top" alt="...">
                                    </a>
                                    <div class="card-body">
                                        <a href="blog-details.html" class="fw-semibold fs-14 text-dark mb-1">Touring excites in winter !</a>
                                    ...
                                    <div class="card-footer">
                                        <div class="d-flex align-items-center justify-content-between">
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div>
                                                    <p class="mb-0 fw-semibold">Justin Kim</p>
                                                    <p class="text-muted fs-10 mb-0">20,Dec 2022 - 16:32</p>
                                                </div>
                                            </div>
                                            <div class="btn-list">
                            ...
                            <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6 col-sm-6">
                                <div class="card custom-card">
                                    <a href="javascript:void(0);">
                                        <img src="../assets/images/media/media-35.jpg" class="card-img-top" alt="...">
                                    </a>
                                    <div class="card-body">
                                        <a href="blog-details.html" class="fw-semibold fs-14 text-dark mb-1"> Boat manufacutrers are in debt !</a>
                                        <p class="card-text text-muted mb-3">when an unknown printer took a galley of type and scrambled it to make a type specimen book.</p>
                                        <a href="javascript:void(0);" class="btn btn-primary-light">Read More</a>
                                    </div>
                                    <div class="card-footer">
                                        <div class="d-flex align-items-center justify-content-between">
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div>
                                                    <p class="mb-0 fw-semibold">Monika Karen</p>
                                                    <p class="text-muted fs-10 mb-0">25,Dec 2022 - 12:45</p>
                                                </div>
                                            </div>
                                            <div class="btn-list">
                                                <button aria-label="button" type="button" class="btn btn-icon btn-light btn-sm"><i class="ri-thumb-up-line"></i></button>
                    ...
                    <div class="col-xl-12">
                        ...
                        <div class="row">
                            <div class="col-xxl-2 col-xl-2 col-md-4 col-sm-4 col-6">
                                <a href="javascript:void(0);">
                                    <div class="card custom-card bg-dark overlay-card text-fixed-white">
                                        <img src="../assets/images/media/media-73.jpg" class="card-img" alt="...">
                            ...
                            <div class="col-xxl-2 col-xl-2 col-md-4 col-sm-4 col-6">
                                <a href="javascript:void(0);">
                                    <div class="card custom-card bg-dark overlay-card text-fixed-white">
                                        <img src="../assets/images/media/media-75.jpg" class="card-img" alt="...">
                                        <div class="card-img-overlay d-flex flex-column p-0 over-content-bottom">
                                            <div class="card-footer border-top-0">
                            ...
                            <div class="col-xxl-2 col-xl-2 col-md-4 col-sm-4 col-6">
                                <a href="javascript:void(0);">
                                    <div class="card custom-card bg-dark overlay-card text-fixed-white">
                                        <img src="../assets/images/media/media-76.jpg" class="card-img" alt="...">
                                        <div class="card-img-overlay d-flex flex-column p-0 over-content-bottom">
                                            <div class="card-footer border-top-0">
                            ...
                            <div class="col-xxl-2 col-xl-2 col-md-4 col-sm-4 col-6">
                                <a href="javascript:void(0);">
                                    <div class="card custom-card bg-dark overlay-card text-fixed-white">
                                        <img src="../assets/images/media/media-77.jpg" class="card-img" alt="...">
                                        <div class="card-img-overlay d-flex flex-column p-0 over-content-bottom">
                                            <div class="card-footer border-top-0">
                            ...
                            <div class="col-xxl-2 col-xl-2 col-md-4 col-sm-4 col-6">
                                <a href="javascript:void(0);">
                                    <div class="card custom-card bg-dark overlay-card text-fixed-white">
                                        <img src="../assets/images/media/media-78.jpg" class="card-img" alt="...">
                                        <div class="card-img-overlay d-flex flex-column p-0 over-content-bottom">
                                            <div class="card-footer border-top-0">
                            ...
                            <div class="col-xl-6 col-xxl-8 col-lg-12 col-md-12">
                                <div class="row">
                                    <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6">
                                        <div class="card custom-card">
                                            <a href="javascript:void(0);">
                                                <img src="../assets/images/media/media-26.jpg" class="card-img-top" alt="...">
                                            </a>
                                            <div class="card-body">
                                                <a href="blog-details.html" class="fw-semibold fs-14 text-dark mb-1">Features of new car !</a>
                                                <p class="card-text text-muted mb-3">The holographic principle, theorized to be a property of quantum gravity, postulates that the description.</p>
                                                <a href="javascript:void(0);" class="btn btn-primary-light">Read More</a>
                                            </div>
                                            <div class="card-footer">
                                                <div class="d-flex flex-wrap align-items-center justify-content-between">
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div>
                                                            ...
                                                            <p class="text-muted fs-10 mb-0">18,Dec 2022 - 12:25</p>
                                                        </div>
                                                    </div>
                                                    <div class="btn-list">
                                    ...
                                    <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6">
                                        <div class="card custom-card">
                                            <a href="javascript:void(0);">
                                                <img src="../assets/images/media/media-31.jpg" class="card-img-top" alt="...">
                                            </a>
                                            <div class="card-body">
                                                <a href="blog-details.html" class="fw-semibold fs-14 text-dark mb-1">Beautiful beach on a sunny day !</a>
                                                <p class="card-text text-muted mb-3">The holographic principle, theorized to be a property of quantum gravity, postulates that the description.</p>
                                                <a href="javascript:void(0);" class="btn btn-primary-light">Read More</a>
                                            </div>
                                            <div class="card-footer">
                                                <div class="d-flex flex-wrap align-items-center justify-content-between">
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div>
                                                            ...
                                                            <p class="text-muted fs-10 mb-0">25,Dec 2022 - 04:25</p>
                                                        </div>
                                                    </div>
                                                    <div class="btn-list">
                                                        <button aria-label="button" type="button" class="btn btn-icon btn-light btn-sm m-1"><i class="ri-thumb-up-line"></i></button>
                    ...
                    <div class="col-xl-12">
                        <div class="row">
                            ...
                            <div class="col-xxl-3 col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                <div class="card custom-card">
                                    <a href="javascript:void(0);">
                                        <img src="../assets/images/media/media-61.jpg" class="card-img-top" alt="...">
                                    </a>
                                    <div class="card-body">
                            ...
                            <div class="col-xxl-3 col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                <div class="card custom-card">
                                    <a href="javascript:void(0);">
                                        <img src="../assets/images/media/media-59.jpg" class="card-img-top" alt="...">
                                    </a>
                                    <div class="card-body">
