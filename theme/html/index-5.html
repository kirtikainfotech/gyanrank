                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-6 pe-0">
                                        ...
                                        <p class="mb-2 fs-12">
                                            <span class="fs-25 fw-semibold lh-1 vertical-bottom mb-0">153</span>
                        ...
                        <div class="card custom-card">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-6 pe-0">
                                        <p class="mb-2">
                                            <span class="fs-16">Total Revenue</span>
                                        </p>
                                        <p class="mb-2 fs-12">
                                            <span class="fs-25 fw-semibold lh-1 vertical-bottom mb-0">$4,32,474</span>
                                            <span class="d-block fs-10 fw-semibold text-muted">THIS MONTH</span>
                                        </p>
                                        <a href="javascript:void(0);" class="fs-12 mb-0 text-primary">Show full stats<i class="ti ti-chevron-right ms-1"></i></a>
                                    </div>
                                    <div class="col-6">
                                        <p class="badge bg-danger-transparent float-end d-inline-flex"><i class="ti ti-caret-down me-1"></i>12%</p>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-6 pe-0">
                                        ...
                                        <p class="mb-2 fs-12">
                                            <span class="fs-25 fw-semibold lh-1 vertical-bottom mb-0">$563</span>
                                            <span class="d-block fs-10 fw-semibold text-muted">THIS MONTH</span>
                                        </p>
                                        <a href="javascript:void(0);" class="fs-12 mb-0 text-primary">Show full stats<i class="ti ti-chevron-right ms-1"></i></a>
                                    </div>
                                    <div class="col-6">
                                        <p class="badge bg-success-transparent float-end d-inline-flex"><i class="ti ti-caret-up me-1"></i>32.5%</p>
                                        <p class="main-card-icon mb-0">
                            ...
                            <div class="card-body p-0 customers">
                                <ul class="list-group my-2">
                                    <li class="list-group-item border-0">
                                        <a href="javascript:void(0);" class="border-0">
                                            <div class="d-flex align-items-top">
                                                <img class="avatar avatar-md me-3 my-auto" src="../assets/images/faces/2.jpg" alt="Image description">
                                                <div class="mt-0">
                                    ...
                                    <li class="list-group-item border-0 mb-2">
                                        <a href="javascript:void(0);" class="border-0">
                                            <div class="d-flex align-items-top">
                                                <img class="avatar avatar-md me-3 my-auto" src="../assets/images/faces/1.jpg" alt="Image description">
                                                <div class="mt-0">
                                    ...
                                    <li class="list-group-item border-0 mb-2">
                                        <a href="javascript:void(0);" class="border-0">
                                            <div class="d-flex align-items-top">
                                                <img class="avatar avatar-md me-3 my-auto" src="../assets/images/faces/5.jpg" alt="Image description">
                                                <div class="mt-0">
                                    ...
                                    <li class="list-group-item border-0 mb-2">
                                        <a href="javascript:void(0);" class="border-0">
                                            <div class="d-flex align-items-top">
                                                <img class="avatar avatar-md me-3 my-auto" src="../assets/images/faces/7.jpg" alt="Image description">
                                                <div class="mt-0">
                                    ...
                                    <li class="list-group-item border-0 mb-2">
                                        <a href="javascript:void(0);" class="border-0">
                                            <div class="d-flex align-items-top">
                                                <img class="avatar avatar-md me-3 my-auto" src="../assets/images/faces/9.jpg" alt="Image description">
                                                <div class="mt-0">
                                    ...
                                    <li class="list-group-item border-0">
                                        <a href="javascript:void(0);" class="border-0">
                                            <div class="d-flex align-items-top">
                                                <img class="avatar avatar-md me-3 my-auto" src="../assets/images/faces/11.jpg" alt="Image description">
                                                <div class="mt-0">
                                                    <p class="mb-1 fw-semibold">Manuel Labor</p>
