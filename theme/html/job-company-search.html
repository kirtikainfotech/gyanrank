                    ...
                    <div class="row">
                            ...
                            <div class="card custom-card products-navigation-card">
                                <div class="card-body p-0">
                                    <div class="p-4 border-bottom">
                                        <h6 class="fw-semibold mb-0">Industry Type</h6>
                                    ...
                                    <div class="p-4 border-bottom">
                                        <h6 class="fw-semibold mb-0">Company Size</h6>
                                        <div class="px-2 py-3 pb-0">
                                            <div class="form-check mb-2">
                                    ...
                                    <div class="p-4 border-bottom">
                                        <h6 class="fw-semibold mb-0">Recruiter Type</h6>
                                        <div class="px-2 py-3 pb-0">
                                            <div class="form-check mb-2">
                                    ...
                                    <div class="p-4 border-bottom">
                                        <h6 class="fw-semibold mb-0">Job Vacancies</h6>
                                        <div class="px-2 py-3 pb-0">
                                            <div class="form-check mb-2">
                                    ...
                                    <div class="p-4 border-bottom">
                                        <h6 class="fw-semibold mb-0">Type of Employement</h6>
                                        <div class="px-2 py-3 pb-0">
                                            <div class="form-check mb-2">
                        ...
                        <div class="col-xxl-9 col-lg-7">
                            ...
                            <div class="card custom-card">
                                <div class="card-body">
                                    <div class="d-flex align-items-center flex-wrap gap-2">
                                        <h5 class="fw-semibold mb-0 flex-grow-1">1287 <span class="fw-normal fs-18">Companies match for your search</span> </h5>
                                        <div class="btn-group">
                            ...
                            <div class="card custom-card">
                                <div class="card-body">
                                    <div class="btn-list float-end">
                                        <a href="javascript:void(0);" class="avatar avatar-rounded bg-light text-default avatar-sm" data-bs-toggle="tooltip" data-bs-placement="top" aria-label="Add to Wishlist" title="Add to Wishlist"><span><i class="bi bi-heart"></i></span></a>
                                    </div>
                                    <div class="d-flex align-items-center flex-wrap gap-2">
                                        <span class="avatar avatar-xl bg-white shadow-sm border p-2 avatar-rounded">
                                            <img src="../assets/images/company-logos/1.png" alt="">
                                        </span>
                                        <div class="ms-2">
                                            <h5 class="fw-semibold mb-0 d-flex align-items-center"><a href="javascript:void(0);"> Spotech Technical Solutions <i class="bi bi-check-circle-fill text-success fs-16" data-bs-toggle="tooltip" title="Verified company"></i></a></h5>
                                ...
                                <div class="card-footer">
                                    <div class="d-flex align-items-center flex-wrap gap-2">
                                        <div class="flex-grow-1">
                                            <a href="javascript:void(0);" class="badge badge-md rounded-pill bg-info-transparent" data-bs-toggle="tooltip" title="No of employees"><i class="bi bi-people me-1"></i>No. of Emp : 345</a>
                                            <a href="javascript:void(0);" class="badge badge-md rounded-pill bg-primary-transparent"><i class="bi bi-briefcase me-1"></i>Vacancies : 50</a>
                                        </div>
                            ...
                            <div class="card custom-card">
                                <div class="card-body">
                                    ...
                                    <div class="d-flex align-items-center flex-wrap gap-2">
                                        ...
                                        <div class="ms-2">
                                            <h5 class="fw-semibold mb-0 d-flex align-items-center"><a href="javascript:void(0);"> G Technical Solutions <i class="bi bi-check-circle-fill text-success fs-16" data-bs-toggle="tooltip" title="Verified company"></i></a></h5>
                                            <div class="d-flex gap-2">
                                ...
                                <div class="card-footer">
                                    <div class="d-flex align-items-center flex-wrap gap-2">
                                        <div class="flex-grow-1">
                                            <a href="javascript:void(0);" class="badge badge-md rounded-pill bg-info-transparent" data-bs-toggle="tooltip" title="No of employees"><i class="bi bi-people me-1"></i>No. of Emp : 146</a>
                                            <a href="javascript:void(0);" class="badge badge-md rounded-pill bg-primary-transparent"><i class="bi bi-briefcase me-1"></i>Vacancies : 40</a>
                                        </div>
                                        <a href="javascript:void(0);" class="btn btn-wave btn-primary">
                                            View Profile <i class="ri-arrow-right-line align-middle"></i>
                                        </a>
                            ...
                            <div class="card custom-card">
                                <div class="card-body">
                                    ...
                                    <div class="d-flex align-items-center flex-wrap gap-2">
                                        ...
                                        <div class="ms-2">
                                            <h5 class="fw-semibold mb-0 d-flex align-items-center"><a href="javascript:void(0);"> Diego Technical Solutions <i class="bi bi-check-circle-fill text-success fs-16" data-bs-toggle="tooltip" title="Verified company"></i></a></h5>
                                            <div class="d-flex gap-2">
                                ...
                                <div class="card-footer">
                                    <div class="d-flex align-items-center flex-wrap gap-2">
                                        <div class="flex-grow-1">
                                            <a href="javascript:void(0);" class="badge badge-md rounded-pill bg-info-transparent" data-bs-toggle="tooltip" title="No of employees"><i class="bi bi-people me-1"></i>No. of Emp : 56</a>
                                            <a href="javascript:void(0);" class="badge badge-md rounded-pill bg-primary-transparent"><i class="bi bi-briefcase me-1"></i>Vacancies : 35</a>
                                        </div>
                                        <a href="javascript:void(0);" class="btn btn-wave btn-primary">
                                            View Profile <i class="ri-arrow-right-line align-middle"></i>
                                        </a>
                            ...
                            <div class="card custom-card">
                                <div class="card-body">
                                    ...
                                    <div class="d-flex align-items-center flex-wrap gap-2">
                                        ...
                                        <div class="ms-2">
                                            <h5 class="fw-semibold mb-0 d-flex align-items-center"><a href="javascript:void(0);"> Spoteck Solutions Pvt Ltd <i class="bi bi-check-circle-fill text-success fs-16" data-bs-toggle="tooltip" title="Verified company"></i></a></h5>
                                            <div class="d-flex gap-2">
                                ...
                                <div class="card-footer">
                                    <div class="d-flex align-items-center flex-wrap gap-2">
                                        <div class="flex-grow-1">
                                            <a href="javascript:void(0);" class="badge badge-md rounded-pill bg-info-transparent" data-bs-toggle="tooltip" title="No of employees"><i class="bi bi-people me-1"></i>No. of Emp : 120</a>
                                            <a href="javascript:void(0);" class="badge badge-md rounded-pill bg-primary-transparent"><i class="bi bi-briefcase me-1"></i>Vacancies : 10</a>
                                        </div>
                                        <a href="javascript:void(0);" class="btn btn-wave btn-primary">
                                            View Profile <i class="ri-arrow-right-line align-middle"></i>
                                        </a>
                            ...
                            <div class="card custom-card">
                                <div class="card-body">
                                    <div class="btn-list float-end">
                                        <a href="javascript:void(0);" class="avatar avatar-rounded bg-light text-default avatar-sm" data-bs-toggle="tooltip" data-bs-placement="top" title="Add to Wishlist"><span><i class="bi bi-heart"></i></span></a>
                                        <a href="javascript:void(0);" class="avatar avatar-rounded bg-light text-default avatar-sm" data-bs-toggle="tooltip" data-bs-placement="top" title="Share this company"><span><i class="bi bi-share"></i></span></a>
                                    </div>
                                    <div class="d-flex align-items-center flex-wrap gap-2">
                                        <span class="avatar avatar-xl bg-white shadow-sm border p-2 avatar-rounded">
                                        ...
                                        <div class="ms-2">
                                            <h5 class="fw-semibold mb-0 d-flex align-items-center"><a href="javascript:void(0);"> Vehement Capital Partners <i class="bi bi-check-circle-fill text-success fs-16" data-bs-toggle="tooltip" title="Verified company"></i></a></h5>
                                            <div class="d-flex gap-2">
                                                <a href="javascript:void(0);"><i class="bi bi-geo-alt fs-11"></i> Gachibowli, Banglore, </a>
                            ...
                            <div class="card custom-card">
                                <div class="card-body">
                                    ...
                                    <div class="d-flex align-items-center flex-wrap gap-2">
                                        ...
                                        <div class="ms-2">
                                            <h5 class="fw-semibold mb-0 d-flex align-items-center"><a href="javascript:void(0);"> Wonka Industries <i class="bi bi-check-circle-fill text-success fs-16" data-bs-toggle="tooltip" title="Verified company"></i></a></h5>
                                            <div class="d-flex gap-2">
