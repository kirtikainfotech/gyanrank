                                ...
                                <div class="card custom-card">
                                            ...
                                            <table class="table text-nowrap">
                                                ...
                                                <tbody>
                                                        ...
                                                        <td>
                                                            <div class="d-flex align-items-center">
                                                                ...
                                                                <div>
                                                                    ...
                                                                    <div class="mb-1">
                                                                        <span class="me-1">Color:</span><span class="text-muted">Grey<span class="badge bg-success ms-3">In Offer</span></span>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </td>
                                                    ...
                                                    <tr>
                                                        <td colspan="2"></td>
                                                        <td colspan="2">
                                                            <div class="fw-semibold">Total Saved :</div>
                                                        </td>
                                                        <td>
                                                            <span class="fs-14 fw-semibold text-success">$3,799</span>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td colspan="2"></td>
                                                        ...
                                                        <td>
                                                            <span class="fs-16 fw-semibold">$3,129</span>
                                                        </td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                    ...
                                    <div class="card-footer border-top-0">
                                        <div class="btn-list float-end">
                                            ...
                                            <button class="btn btn-secondary btn-wave btn-sm"><i class="ri-share-forward-line me-1 align-middle d-inline-block"></i>Share Details</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="card-body p-0">
                                        <div class="d-flex align-items-center border-bottom border-block-end-dashed p-3 flex-wrap">
                                            ...
                                            <div class="flex-fill">
                                                ...
                                                <p class="mb-0 text-muted fs-12">jsontaylor2135@gmail.com</p>
                                            </div>
                                            <div>
                                                <span class="badge bg-primary-transparent">Prime User</span>
                                            </div>
                                        </div>
