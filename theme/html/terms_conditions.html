...
<body>
        ...
        <div class="main-content app-content">
            <div class="container-fluid">
                ...
                <div class="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
                    <h1 class="page-title fw-semibold fs-18 mb-0">Terms & Conditions</h1>
                        ...
                        <div class="col-xl-8">
                            <div class="card custom-card overflow-hidden">
                                <div class="card-body p-0">
                                    <div class="p-3 terms-heading-cover d-flex align-items-center text-fixed-white bg-primary h5 fw-semibold mb-0">
                                    ...
                                    <div class="p-4 text-muted terms-conditions" id="terms-scroll">
                                        <div class="mb-5">
                                            <p class="mb-3 op-7">
                                                <span class="fw-bold text-default op-8">If you stay in the USA </span>the ynex <a class="text-primary" href="javascript:void(0);"><u>Terms and Conditions</u></a> consists of below rules and <a class="text-primary" href="javascript:void(0);"><u>User Agreements</u></a> consists of below policies <a class="text-primary" href="javascript:void(0);"><u>Ynex Rules & Privacy Policies</u></a> incorporated with the below conditions.
                                            </p>
                                            <p class="mb-0 op-7">
                                                <span class="fw-bold text-default op-8">If you stay any where in the world other than USA </span>the ynex <a class="text-primary" href="javascript:void(0);"><u>Terms and Conditions</u></a> consists of below rules and <a class="text-primary" href="javascript:void(0);"><u>User Agreements</u></a> consists of below policies <a class="text-primary" href="javascript:void(0);"><u>Ynex Rules & Privacy Policies</u></a> incorporated with the below conditions.
                                            </p>
                                        </div>
                                    ...
                                    <div>
                                        <div class="form-check">
                                            ...
                                            <label class="form-check-label text-muted" for="privacy-policy">
                                                I agree with the 
                                            </label><a href="javascript:void(0);" class="fw-semibold text-muted ms-1"><u>Privacy Policy</u></a>
                                        </div>
                                        <div class="form-check d-block">
                                            ...
                                            <label class="form-check-label text-muted" for="terms_conditions">
                                                I agree with the 
                                            </label><a href="javascript:void(0);" class="fw-semibold text-muted ms-1"><u>Terms & Conditions</u></a>
                                        </div>
                                    </div>
                                    <div class="btn-list mt-sm-0 mt-2">
                                        <button class="btn btn-outline-danger btn-wave">DECLINE</button>
                                        <button class="btn btn-primary btn-wave">ACCEPT</button>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <script src="../assets/js/terms_conditions.js"></script>
