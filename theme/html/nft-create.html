...
<body>
                ...
                <div class="row">
                    ...
                    <div class="col-xxl-3 col-xl-4">
                        <div class="card custom-card">
                            ...
                            <div class="card-body">
                                <div class="card custom-card mb-0 shadow-none border">
                                    ...
                                    <div class="d-flex align-items-center justify-content-between nft-like-section w-100 px-3">
                                        <div class="flex-fill">
                                            <button type="button" aria-label="anchor" class="btn btn-sm btn-icon btn-success rounded-pill btn-wave waves-effect waves-light">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="d-flex flex-wrap align-itesm-center justify-content-between">
    ...
    <!-- Create NFT JS -->
    <script src="../assets/js/nft-create.js"></script>
