                            ...
                            <div class="card custom-card">
                                <div class="card-body p-3">
                                    <div class="row align-items-center">
                                        <div class="col-sm-8">
                                            <div class="d-flex">
                                                <h5 class="fw-semibold mb-0"><span class="fw-normal">Showing</span> 3456 Jobs</h5>
                                            </div>
                                        </div>
                            ...
                            <div class="card custom-card featured-jobs">
                                <div class="card-body">
                                    <div class="btn-list float-end">
                                        <a href="javascript:void(0);" class="avatar avatar-rounded avatar-sm bg-light text-default" data-bs-toggle="tooltip" data-bs-placement="top" aria-label="Add to wishlist" data-bs-original-title="Add to wishlist"><span><i class="bi bi-heart"></i></span></a>
                                        <a href="javascript:void(0);" class="avatar avatar-rounded avatar-sm bg-warning-transparent" data-bs-toggle="tooltip" data-bs-placement="top" aria-label="Featured Jobs" data-bs-original-title="Featured Jobs"><span><i class="bi bi-star-fill"></i></span></a>
                                    </div>
                                    <div class="d-flex mb-3 flex-wrap gap-2 align-items-center">
                                        ...
                                        <div>
                                            <h5 class="fw-semibold mb-0 d-flex align-items-center"><a href="javascript:void(0);"> HTML Developer - Fresher</a></h5>
                                    ...
                                    <div class="d-flex justify-content-between">
                                        ...
                                        <a href="" class="text-primary fw-semibold fs-14 d-inline-flex">
                            ...
                            <div class="card custom-card featured-jobs">
                                <div class="card-body">
                                    ...
                                    <div class="d-flex mb-3 flex-wrap gap-2 align-items-center">
                                        ...
                                        <div>
                                            <h5 class="fw-semibold mb-0 d-flex align-items-center"><a href="javascript:void(0);"> React Lead Developer</a></h5>
                            ...
                            <div class="card custom-card featured-jobs">
                                <div class="card-body">
                                    ...
                                    <div class="d-flex mb-3 flex-wrap gap-2 align-items-center">
                                        ...
                                        <div>
                                            <h5 class="fw-semibold mb-0 d-flex align-items-center"><a href="javascript:void(0);"> Vuejs Frontend Developer</a></h5>
                            ...
                            <div class="card custom-card featured-jobs">
                                <div class="card-body">
                                    ...
                                    <div class="d-flex mb-3 flex-wrap gap-2 align-items-center">
                                        ...
                                        <div>
                                            <h5 class="fw-semibold mb-0 d-flex align-items-center"><a href="javascript:void(0);"> Wordpress Developer - Remote</a></h5>
